...
//  dyscMusic
//
//  Created by bajo on 2022-05-25.
//

import UIKit

struct TrackDeailHeader: Codable{
    var id: String
    var type: String?
    var title: String
    var name: String
...
struct TrackDetailSections: Codable{
    ...
    var type: String
    var tagline: String
    var items: [TrackDetailItems]
}
struct TrackDetailItems: Codable, Hashable {
    var id: String
    var type: String?
    var trackNum: UInt?
    var genre: String?
